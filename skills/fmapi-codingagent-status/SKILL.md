...
2. Present the output to the user. The status dashboard shows:
...
3. If the command exits with an error indicating no config was found, inform the user they need to run `/fmapi-codingagent-setup` first.
